...
*🌹ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}
    ...
    menubutton = [{buttonId:`${prefix}alive`,buttonText:{displayText:'𝐀𝐋𝐈𝐕𝐄😐'},type:1}
]
 ...
 //------------------< Extra >-------------------
      ...
      case 'tod':
        ...
        case 'anime':
              ...
              imageMsg = ( await bosco.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), 'imageMessage', {thumbnail: Buffer.alloc(0)})).message.imageMessage
              buttonsMessage = {footerText:'© 𝒎𝒂𝒅𝒆 𝒃𝒈 𝒃𝒆𝒍𝒄𝒐', imageMessage: imageMsg,
