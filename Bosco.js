 ...
 *🌹ʙᴀᴛᴛᴇʀʏ* : uncnoun%\n
 ...
 ${jmn} -  ${jmo}\n${week} - ${calender}\n©ᴀᴍ ʙᴇʟᴄᴏ sɪʀ
 `
 menubutton = [{buttonId:`${prefix}menu2`,buttonText:{displayText:'𝙽𝙴𝚇𝚃⚣︎'},type:1},
 {buttonId:`${prefix}sc`,buttonText:{displayText:'𝚂𝙲𝚁𝙸𝙿𝚃⚢︎'},type:1}
]
...
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: '𝗣𝗨𝗕𝗟𝗜𝗖😝'}, type: 1},{buttonId: `self`, buttonText: {displayText: '𝗦𝗘𝗟𝗙𝗘😑'}, type: 1}]
const buMess = {
    contentText: "*🅂🄴🄻🄵/🅿︎🆄︎🅱︎🅻︎🅸︎🅲*",
    footerText: '𝙲𝙷𝙾𝙸𝙲𝙴 𝙰𝙽𝚈 𝙾𝙽𝙴 𝚅𝚁𝙾🎗️..!',
    buttons: buttonss,
    headerType: 1
}
