...
╰────────────────❋ཻུ۪۪
`
    menubutton = [{buttonId:`${prefix}credits`,buttonText:{displayText:'🙂📌'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `© ᴀᴍ ʙᴇʟᴄᴏ sᴇʀ ♔︎`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
