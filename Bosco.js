...
// Anti link
 ...
 ${jmn} -  ${jmo}\n${week} - ${calender}
 `
 menubutton = [{buttonId:`${prefix}menu2`,buttonText:{displayText:'🦋ʙᴏᴛ ᴍᴇɴᴜ🦋'},type:1},
 {buttonId:`${prefix}sc`,buttonText:{displayText:'🙂ʙᴏᴛ sᴄʀɪᴘᴛ🙂'},type:1},
                    ...
                    case 'getname':
                      ...
                      const sname = bosco.contacts[ambl] != undefined ? bosco.contacts[ambl].notify = undefined ? PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international') : bosco.contacts[ambl].notify || bosco.contacts[ambl].vname : PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international')
                       reply(sname)
                        break
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: 'ᴘᴜʙʟɪᴄ😝'}, type: 1},{buttonId: `self`, buttonText: {displayText: 'sᴇʟғ😑️'}, type: 1}]
const buMess = {
