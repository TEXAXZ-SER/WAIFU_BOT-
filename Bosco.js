...
ʜɪ ʙʀᴏ @${sender.split("@")[0]}
 ...
 ❣️ᵘˢᵉ ᵗʰᵉ ᵇᵘᵗᵗᵒⁿ ᵃⁿᵈ ᵉⁿʲᵒʸ❣️
 
 ${jmn} -  ${jmo}\n${week} - ${calender}
 `
 menubutton = [{buttonId:`${prefix}menu2`,buttonText:{displayText:'𝐁𝐎𝐓 𝐌𝐄𝐍𝐔👾'},type:1},
 {buttonId:`${prefix}owner`,buttonText:{displayText:'𝐎𝐖𝐍𝐄𝐑 𝐁𝐎𝐓🌞'},type:1},
 {buttonId:`${prefix}boscogroup`,buttonText:{displayText:'𝐍𝐈𝐂𝐄😇'},type:1}
]
...
teks = `
*👾 ẉa.me/❣︎ⁱᵗˢᵐᵉᗷᗴᒪᑕO𝓼𝓮𝓻♔︎¹⁰ 👾*

*🌹ʜʏ ᴅᴜᴅᴇ ᴀᴍ ᴀʟɪᴠᴇ ɴᴏᴡ😵 :)*

*🌹sᴘᴇᴇᴅ :* ${latensie.toFixed(4)} Second

*🌹ʙᴀᴛᴛᴇʀʏ :* ${baterai}% ${charger}

*🌹ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}

    menubutton = [{buttonId:`${prefix}owner`,buttonText:{displayText:'𝗢𝗪𝗡𝗘𝗥'},type:1}
]
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${vien.length}*\n\n_🌹_`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}𝒌𝒓𝒊𝒛 𝒔𝒆𝒓${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/919567941560'}`}},quoted: ftext})
					break
				case 'addimage':
				    if (!isOwner) return
